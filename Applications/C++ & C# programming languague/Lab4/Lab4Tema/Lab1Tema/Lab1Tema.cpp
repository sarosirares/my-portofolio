...
int main()
{
	...
	*/
	...
	//Sport Dan;  (error - abstract class)

	cout << " \n === Interface === \n" << endl;

	cout << "Athlete name: " << Mihai.get_AthleteName() << endl << endl;
	cout << "Athlete name: " << Edi.get_AthleteName() << endl << endl;
	cout << "Athlete name: " << Dan.get_AthleteName() << endl << endl;
	cout << "Athlete name: " << ptr1->get_AthleteName() << endl << endl;
	cout << "Athlete name: " << ptr2->get_AthleteName() << endl << endl;
