...
public class StudentManager_v2 {
    //attributes
    ...
    public void addStudent(int readID, String readName) {
    ...
    public void addStudentGrades(int readID, String readSubject, int readGrade) {
        StudentValues student = searchStudent(readID);
        if (student != null) {
            if (readGrade >= 0) {
    ...
    public void removeStudent(int readID) {
        StudentValues student = searchStudent(readID);
        if (student != null) {
    ...
    public void updateStudent(int readID, String newName) {
        StudentValues student = searchStudent(readID);
        if (student != null) {
        ...
        do {
            ...
            switch (opt) {
                ...
                case 2 -> {
                    ...
                    scanner.nextLine();
                    addStudentGrades(readID, readSubject, readGrade);
                }
                case 3 -> {
                    System.out.println("Enter the student's ID that you want to remove: ");
                    int readID = scanner.nextInt();
                    scanner.nextLine();
                    removeStudent(readID);
                }
                case 4 -> {
